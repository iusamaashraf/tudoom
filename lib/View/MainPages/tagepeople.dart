...
class TagePeople extends StatefulWidget {
  @override
  State<TagePeople> createState() => _InvitePeopleState();
}

class _InvitePeopleState extends State<TagePeople> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                controller: controller.searchFirend,
                onChanged: (value) {
                  setState(() {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final friend = controller.postTageFirnd[index];
                  if (search.isEmpty ||
                ...
                itemCount: controller.postTageFirnd.length,
              ),
            ),
          ],
        ),
          ...
          Padding(
            ...
            child: RoundButton(
              ...
              fun: () {
                ...
                //     context, "/CreateRommLoading", (route) => false);
              },
              backcol: appColor,
            ),
          )
